...
{
    /// <summary>
    /// Exports the SysCompRegionNavigationJournal using the Managed Extensibility Framework (MEF).
    /// </summary>
    /// <remarks>
    ...
    public class SysCompRegionNavigationJournal : RegionNavigationJournal
    {
    }
}
